...
namespace DemoAspose.Tests.FileWriter;
public class FileWriterTests : IDisposable
{
    ...
    {
        _fileWriter = new DemoAspose.FileWriter.FileWriter();
        _tempFilePath = Path.GetTempFileName(); 
    }

    [Fact]
    public async Task WriteLinesAsync_ShouldWriteLinesToFile()
    {
        // Arrange
    ...
    [Fact]
    public async Task WriteLinesAsync_ShouldHandleEmptyLines()
    {
        // Arrange
    ...
    [Fact]
    public async Task WriteLinesAsync_ShouldHandleNullLine()
    {
        // Arrange
    ...
    [Fact]
    public async Task WriteLinesAsync_ShouldHandleSingleLine()
    {
        // Arrange
    ...
    [Fact]
    public async Task WriteLinesAsync_ShouldHandleNullLines()
    {
        // Arrange
        var lines = new List<string> { "Single Line" };
